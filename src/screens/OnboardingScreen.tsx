...
const OnboardingScreen = () => {
  ...
  return (
    <View style={tw("mx-5")}>
      ...
      <View style={tw("my-2")}>
        <Text style={tw("my-4 text-xs")}>
          Please enter your shipping information, this is what sellers will use
          to ship your purchased items, please ensure this information is
        ...
        <TextInput
          ...
          control={control}
        ></TextInput>
        <TextInput label="Country" name="country" control={control}></TextInput>
      </View>
